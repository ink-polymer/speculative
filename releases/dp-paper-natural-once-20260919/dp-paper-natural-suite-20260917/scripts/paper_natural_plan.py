...
def cases_for(phase):
    cases = []
    def add(datasets, budgets, cs, caps, names, requests=128, seeds=SEEDS, repeats=3, temperatures=(1,)):
...
def manifest():
    return {'version': 1, 'datasets': DATASETS, 'model_targets': ['qwen3_4b', 'qwen3_8b'],
